...
def final_update():
    ...
    data['regional_cover_letters']['china_zh'] = "尊敬的招聘负责人：\n\n作为专注于医疗AI和生产级机器学习系统的AI/ML工程师，我曾在PhysioNet数据集上开发并验证了94% F1-score的1D ResNet心电图异常检测模型，并在Logixbuilt Infotech构建了日均1万+请求的高可用REST API。\n\n我具备从模型验证到生产部署的端到端经验，包括FastAPI后端、PostgreSQL性能优化以及实时AI服务的稳定交付。\n\n我关注清华大学、北京大学、阿里巴巴达摩院、百度健康和平安好医生在医学影像与心脏AI领域的实际应用进展，并正在学习普通话以便更好地融入中国团队。\n\n我还计划通过贵公司申请Z类工作签证，并已做好赴华工作的充分准备。希望能够在贵公司推动医疗AI产品落地，并支持从研发到部署的全流程交付。此致敬礼。"
    data['regional_cover_letters']['china'] = "I am writing to express my strong interest in AI/ML roles within China's leading healthcare AI market. I have followed work from Tsinghua and Alibaba DAMO Academy, and I am studying Mandarin Chinese to support effective communication in a Chinese engineering team. I require Z-visa sponsorship for employment in China and am fully prepared to relocate."
    data['regional_cover_letters']['china_en'] = "Dear Hiring Manager,\n\nI am writing to express my strong interest in AI/ML roles within China's leading healthcare AI market. I have followed work from Tsinghua and Alibaba DAMO Academy, and I am studying Mandarin Chinese to support effective communication in a Chinese engineering team. I would require Z work visa sponsorship through the hiring company and am fully prepared to relocate to China.\n\nI believe my experience building high-reliability FastAPI backends and validating 1D ResNet cardiac AI models is well-suited to teams focused on medical imaging and predictive health services in China.\n\nBest regards,\n\nDivya Nirankari\ndvnirankari@gmail.com | {phone}"
